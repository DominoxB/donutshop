<template>
  <div class="bg-slate-200 w-3/4 font-garamond border border-black rounded block mt-12 ml-auto mr-auto p-4">
    ...
    <div class="flex text-lg mb-2">
      <input type="radio" value="gotówka" id="cash" name="selected" v-model="selected"/>
      <label>Gotówka przy odbiorze</label>
      <img src="@/images/cash.png" class="w-10 h-8 ml-2"/>
    </div>
    <div class="flex text-lg mb-2">
      <input type="radio" value="karta płatnicza" id="card" name="selected" v-model="selected"/>
      <label>Karta płatnicza</label>
      <img src="@/images/karta.png" class="w-20 h-6 ml-2"/>
    </div>
    <div class="flex text-lg mb-2">
      <input type="radio" value="przelew internetowy" id="transfer" name="selected" v-model="selected"/>
      <label>Przelewy24 (szybki przelew online)</label>
      <img src="@/images/przelewy.png" class="w-12 h-6 ml-2"/>
    </div>
    <div class="flex text-lg mb-2">
      <input type="radio" value="blik" id="blik" name="selected" v-model="selected"/>
      <label>Blik</label>
    ...
    <div class="flex text-lg mb-2">
      <input type="radio" value="paczkomat InPost Fresh" id="inpost" name="delivery" v-model="delivery"/>
      <label>Paczkomat InPost Fresh (9,99)</label>
    </div>
    <div class="flex text-lg mb-2">
