<template>
  <div
    class="bg-slate-200 w-3/4 font-garamond border border-black rounded block mt-12 ml-auto mr-auto p-4"
  >
    <!-- SPOSÓB PŁATNOŚCI -->
